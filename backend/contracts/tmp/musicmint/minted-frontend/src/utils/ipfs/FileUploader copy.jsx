...
const FileUploader = () => {
    ...
    */
    const uploadMetadata = async (fileImageCid, fileSoundTrackCid) => {
        ...
        s3.putObject(params, (err, data) => {
            if (err) {
                ...
                console.log("Successfully uploaded JSON metadata file", data);
            }
        });
        // s3.putObject(params)
        ...
        //             console.log("metadata ipfs", fileSoundTrackCid)
